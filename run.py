...
if environ.get('WERKZEUG_RUN_MAIN') == 'true':
    display = LEDDisplay(led_slowdown_gpio=4, led_gpio_mapping="adafruit-hat",limit_refresh_rate_hz=120, font_path=DEFAULT_FONT_PATH, bold_font_path=DEFAULT_BOLD_FONT_PATH, led_chain=2)
